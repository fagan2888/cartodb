...
describe('dashboard/views/profile/profile-form/profile-form-view', function () {
  ...
  describe('escape inputs', function () {
    beforeEach(function () {
      var MALICIOUS_TEXT = '/><script>alert("wadus");</script>';
    ...
    it('should render the given inputs escaped', function () {
      var ESCAPED_TEXT = Utils.escapeHTML(MALICIOUS_TEXT);

      view.render();

      expect(view.$el.html()).toContain(`<input class="CDB-InputText CDB-Text FormAccount-input FormAccount-input--small u-rspace-s" id="user_name" name="user[name]" placeholder="profile.views.form.first_name" size="30" type="text" value="${ESCAPED_TEXT}">`);
      expect(view.$el.html()).toContain(`<input class="CDB-InputText CDB-Text FormAccount-input FormAccount-input--small" id="user_last_name" name="user[last_name]" placeholder="profile.views.form.last_name" size="30" type="text" value="${ESCAPED_TEXT}">`);
      expect(view.$el.html()).toContain(`<input class="CDB-InputText CDB-Text FormAccount-input FormAccount-input--med is-disabled" id="user_email" name="user[email]" size="30" type="text" value="${ESCAPED_TEXT}" readonly="readonly">`);
      expect(view.$el.html()).toContain(`<input class="CDB-InputText CDB-Text FormAccount-input FormAccount-input--med" id="user_company" name="user[company]" size="30" type="text" value="${ESCAPED_TEXT}">`);
      expect(view.$el.html()).toContain(`<input class="CDB-InputText CDB-Text FormAccount-input FormAccount-input--med" id="user_phone" name="user[phone]" size="30" type="text" value="${ESCAPED_TEXT}">`);
      expect(view.$el.html()).toContain(`<input class="CDB-InputText CDB-Text FormAccount-input FormAccount-input--med" id="user_website" name="user[website]" size="30" type="text" value="${ESCAPED_TEXT}">`);
      expect(view.$el.html()).toContain(`<input class="CDB-InputText CDB-Text FormAccount-input FormAccount-input--med" id="user_location" name="user[location]" size="30" type="text" value="${ESCAPED_TEXT}">`);
      expect(view.$el.html()).toContain(`<textarea class="CDB-Textarea CDB-Text FormAccount-textarea FormAccount-input FormAccount-input--totalwidth" cols="40" id="user_description" name="user[description]" rows="20">${ESCAPED_TEXT}</textarea>`);
      expect(view.$el.html()).toContain(`<input class="CDB-InputText CDB-Text FormAccount-input FormAccount-input--med" id="user_twitter_username" name="user[twitter_username]" size="30" type="text" value="${ESCAPED_TEXT}">`);
      expect(view.$el.html()).toContain(`<input class="CDB-InputText CDB-Text FormAccount-input FormAccount-input--med" id="user_disqus_shortname" name="user[disqus_shortname]" placeholder="profile.views.form.disqus_placeholder" size="30" type="text" value="${ESCAPED_TEXT}">`);
    });
  });
